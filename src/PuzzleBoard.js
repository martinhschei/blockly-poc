...
class BlockEditor extends Component {
    ...
    Blockly.Blocks['ping_configuration'] = {
      init: function() {
        this.appendDummyInput()
            ...
            .appendField(new Blockly.FieldDropdown([["A","OptionA"], ["B","OptionB"], ["C","OptionC"]]), "Transducer");
        this.appendDummyInput()
            .appendField("Mode")
            .appendField(new Blockly.FieldDropdown([["Active","A"], ["Passive","B"]]), "Mode");
        this.appendDummyInput()
            .appendField("Range (m)")
            .appendField(new Blockly.FieldNumber(0, 1, Infinity, 1), "Range");
        this.appendDummyInput()
            .appendField("TX Power (W)")
            .appendField(new Blockly.FieldDropdown([["250","A"], ["500","B"], ["750","C"], ["1000","D"]]), "Power");
        this.setColour(210);
  ...
  render() {
    return (
      <div>
        <div id="blocklyDiv" style={{ height: '1000px', width: '1024px' }}></div>
      </div>
    );
  }
}
